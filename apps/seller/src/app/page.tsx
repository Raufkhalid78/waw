    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 rounded-2xl bg-[#0f172a] border border-slate-800 shadow-lg space-y-3">
          ...
          <div className="text-2xl font-black text-white">PKR {totalGrossPkr.toLocaleString()}</div>
        ...
        <div className="p-5 rounded-2xl bg-[#0f172a] border border-slate-800 shadow-lg space-y-3">
          ...
          <div className="text-2xl font-black text-amber-400">PKR {netEarningsPkr.toLocaleString()}</div>
          <div className="text-[11px] text-slate-400 font-medium">After 10% platform take</div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-[#0f172a] border border-slate-800 shadow-lg space-y-3">
          ...
          <div className="text-2xl font-black text-white">{pendingShipments} Packages</div>
            ...
            <tbody className="divide-y divide-slate-800/60 font-medium text-slate-300">
              {orders.slice(0, 5).map((order) => (
                <tr key={order.id} className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="py-3 px-4 font-bold text-white">PKR {order.sellerPayoutPkr.toLocaleString()}</td>
