  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 font-sans">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl space-y-6">
        ...
        {/* Social OAuth — available on the buyer storefront only; seller
            accounts are provisioned via phone/email through this portal. */}
        <p className="text-center text-[11px] text-slate-500 leading-relaxed">
          Google &amp; Apple sign-in is supported on the Waw storefront. New
          seller? The phone tab above registers your merchant account
          instantly.
        </p>
      </div>
    </div>
