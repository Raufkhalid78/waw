    ...
    <div className="w-full px-3 sm:px-6 lg:px-10 xl:px-12 py-8 space-y-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xs space-y-3">
          ...
          <h3 className="font-black text-base text-slate-950">3. 7-Day Hassle-Free Return</h3>
          <p className="text-xs text-slate-600 leading-relaxed font-medium">
            If an item arrives damaged, defective, or different from photos, claim a full refund or direct exchange with free doorstep reverse pickup.
          </p>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xs space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-5 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
            <div className="font-black text-sky-600 text-xs uppercase tracking-wider">Step 2</div>
            <div className="font-black text-sm text-slate-950">Live Courier Tracking</div>
            <p className="text-xs text-slate-600 font-medium leading-relaxed">
              TCS / PostEx delivers the package with real-time GPS tracking milestones and automated WhatsApp SMS updates to your phone.
            </p>
          </div>

          <div className="p-5 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
            <div className="font-black text-emerald-600 text-xs uppercase tracking-wider">Step 3</div>
            <div className="font-black text-sm text-slate-950">Confirmation & Settlement</div>
            <p className="text-xs text-slate-600 font-medium leading-relaxed">
              Once courier marks delivered and the 7-day inspection window passes smoothly, the net payout is released to the seller.
            </p>
          </div>
        </div>
      </div>
