...
import { RotateCcw, ShieldCheck, Truck, CheckCircle2, ArrowLeft, Clock } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-8">
      ...
      <div className="space-y-3">
        ...
        <h1 className="text-3xl sm:text-4xl font-black text-slate-950 tracking-tight">
          {isUrdu ? 'واپسی اور رقم کی واپسی کی پالیسی' : 'Returns & 100% Money-Back Policy'}
        </h1>
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xs space-y-8 text-slate-700 text-sm leading-relaxed">
        <section className="space-y-3">
          ...
          <p>
            You have a full <strong>7 calendar days</strong> from the moment PostEx marks your package as delivered to test, inspect, and verify your item.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-1 text-xs sm:text-sm text-slate-600">
            ...
            <li>Item does not match website specifications, photos, or description.</li>
            <li>Incorrect size, color, or wrong SKU delivered.</li>
            <li>Counterfeit or suspected unauthentic goods (100% instant refund).</li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            You never have to visit a courier franchise or pay return shipping fees. When you initiate a return via your account or <Link href="/orders/WAW-PK-88492/return" className="text-amber-600 font-bold hover:underline">Self-Service Return Wizard</Link>, a PostEx courier rider will collect the parcel directly from your doorstep within 24 hours.
          </p>
        </section>
