...
export default function SellOnWawPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const appRef = `KYC-WAW-${Math.floor(10000 + Math.random() * 90000)}`;
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-amber-950 text-white rounded-3xl p-8 sm:p-12 border border-slate-800 shadow-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8 pt-8 border-t border-slate-800/80">
          <div className="flex items-start gap-3 bg-slate-900/60 backdrop-blur-xs p-4 rounded-2xl border border-slate-800">
            ...
            <div>
              <div className="text-xs font-black text-white">0% Listing Fee</div>
              <div className="text-[11px] text-slate-400 mt-0.5">Pay only 10% on successful delivered sales</div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 bg-slate-900/60 backdrop-blur-xs p-4 rounded-2xl border border-slate-800">
            ...
            <div>
              <div className="text-xs font-black text-white">Nationwide TCS Logistics</div>
              <div className="text-[11px] text-slate-400 mt-0.5">Automated doorstep pickups & label generation</div>
            </div>
          </div>
      ...
      {!submitted ? (
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xs max-w-3xl mx-auto space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-xs">
            ...
            {step === 1 && (
              <div className="space-y-4">
                <div className="space-y-1">
                  <label className="font-bold text-slate-700 block">Store / Brand Name *</label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="font-bold text-slate-700 block">Primary Category *</label>
                    <select
                  ...
                  <div className="space-y-1">
                    <label className="font-bold text-slate-700 block">Origin City *</label>
                    <select
                      value={formData.city}
                ...
                <div className="space-y-1">
                  <label className="font-bold text-slate-700 block">Workshop / Business Address *</label>
                  <textarea
                    required
                    rows={2}
                ...
                <button
                  type="button"
                  onClick={() => formData.storeName && formData.businessAddress ? setStep(2) : alert('Please fill in your store details.')}
            ...
            {step === 2 && (
              <div className="space-y-4">
                <div className="space-y-1">
                  <label className="font-bold text-slate-700 block">Owner Full Name (as on CNIC) *</label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="font-bold text-slate-700 block">National CNIC Number *</label>
                    <input
                      type="text"
                      required
                  ...
                  <div className="space-y-1">
                    <label className="font-bold text-slate-700 block">FBR NTN Tax Number (Optional)</label>
                    <input
                      type="text"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => formData.ownerName && formData.cnic && formData.whatsappPhone ? setStep(3) : alert('Please fill in your CNIC and contact details.')}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-amber-400 font-medium"
                  >
                    {['Meezan Bank Ltd', 'Habib Bank Limited (HBL)', 'Bank Alfalah', 'Standard Chartered Bank', 'MCB Bank', 'United Bank Limited (UBL)', 'Faysal Bank'].map((b) => (
                ...
                <div className="space-y-1">
                  <label className="font-bold text-slate-700 block">Title of Account (Must match CNIC) *</label>
                  <input
                    type="text"
                    required
                    placeholder="e.g. Muhammad Aslam"
                ...
                <div className="space-y-1">
                  <label className="font-bold text-slate-700 block">24-Digit Pakistani IBAN *</label>
                  <input
                    type="text"
                    required
                ...
                <div className="flex items-center gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="w-2/3 py-3.5 bg-amber-400 hover:bg-amber-500 text-slate-950 font-black rounded-xl text-xs flex items-center justify-center gap-2 transition-all shadow-md cursor-pointer"
                  >
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 sm:p-12 text-center max-w-xl mx-auto space-y-5 shadow-xs">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-black text-slate-950">KYC Application Submitted!</h2>
            <p className="text-xs text-slate-600 leading-relaxed font-medium">
              Thank you for applying to sell on Waw Market. Your application has been logged under verification ID:
            </p>
          ...
          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 text-left text-xs space-y-1.5 text-slate-600">
            ...
            <p>1. Our compliance team will verify your CNIC credentials within 2-4 business hours.</p>
            <p>2. You will receive an automated WhatsApp confirmation on <strong className="text-slate-900">{formData.whatsappPhone || '+92 300 1234567'}</strong>.</p>
