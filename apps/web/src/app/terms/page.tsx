    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-8">
      ...
      <div className="space-y-3">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-50 text-amber-800 text-xs font-bold border border-amber-200">
          ...
          <span>
            {isUrdu ? "قوانین و ضوابط — واو پاکستان" : "Waw Marketplace Terms"}
          </span>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xs space-y-8 text-slate-700 text-sm leading-relaxed">
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-1 text-xs sm:text-sm text-slate-600">
            <li>
              <strong>First-Party (1P Waw Retail):</strong> Direct retail
              inventory owned, inspected, and guaranteed with 24-hour Waw
              Express dispatch.
            </li>
            <li>
              <strong>Third-Party (3P Verified Merchants):</strong> Independent
              vetted artisans, regional manufacturers, and brand distributors
              across Pakistan.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            Payments are locked in escrow until shipment delivery is confirmed
            by PostEx. In the event of a dispute or counterfeit complaint, Waw
            Arbitration mediates within 24 hours to enforce 100% money-back
            refunds.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-1 text-xs sm:text-sm text-slate-600">
            <li>
              Dispatch ordered inventory within 24–48 hours via contracted
              PostEx logistics.
            </li>
            <li>
              List genuine products with authentic imagery and honest
              descriptions. Counterfeit items result in immediate suspension and
              forfeiture of escrow funds.
            </li>
