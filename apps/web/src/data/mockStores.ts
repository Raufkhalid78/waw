...
export const STORES_CATALOG: Record<string, StoreDetail> = {
  ...
  "waw-official-hub": {
    ...
    logoImage:
      "https://images.unsplash.com/photo-1606503829059-86644f1c93a0?w=200&auto=format&fit=crop&q=80",
    about:
  ...
  "royal-fragrances": {
    ...
    logoImage:
      "https://images.unsplash.com/photo-1547887537-6158d64c35b3?w=200&auto=format&fit=crop&q=80",
    about:
