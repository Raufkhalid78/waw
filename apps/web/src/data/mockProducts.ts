...
export const CATALOG_PRODUCTS: ProductDetail[] = [
    ...
    reviews: [
      {
        ...
        date: "3 days ago",
        comment:
          "Received smoothly with Waw Express in 4 days! The leather aroma is 100% authentic and the stitching is superb.",
      ...
      },
      {
        ...
        date: "1 week ago",
        comment:
          "Very slim wallet that fits easily in pocket. Holds 5000 and 1000 PKR notes without bending them.",
        verifiedPurchase: true,
      },
      {
        id: "rev_3",
        ...
        date: "2 weeks ago",
        comment:
          "Premium packaging. Came in a nice wooden gift box with a leather care card. Highly recommended!",
        verifiedPurchase: true,
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        date: "Yesterday",
        comment:
          "Bass is unbelievable for this price! Call quality in traffic is very clear thanks to ENC.",
        verifiedPurchase: true,
      },
      {
        id: "rev_202",
        ...
        date: "5 days ago",
        comment:
          "Pairs instantly with my iPhone. Battery lasted the entire 4-day trip on a single charge.",
        verifiedPurchase: true,
      },
    ],
  },
  {
    productId: "prod_m3",
    title:
      "Handmade Traditional Norozi Peshawari Chappal (Pure Mustard Leather)",
    category: "Leather & Footwear",
    pricePkr: 3800,
    ...
    reviews: [
      {
        ...
        date: "2 days ago",
        comment:
          "Asli Peshawari chappal! Sole is heavy and strong, fits Shalwar Kameez perfectly.",
        verifiedPurchase: true,
      },
      {
        id: "rev_302",
        ...
        date: "1 week ago",
        comment:
          "Extremely comfortable for standing all day. Size guide was 100% accurate.",
        verifiedPurchase: true,
      },
    ],
  },
  {
    productId: "prod_m4",
    title:
      "Ultra Smart Fitness Watch 2026 (AMOLED Display & Bluetooth Calling)",
    ...
    reviews: [
      {
        ...
        date: "4 days ago",
        comment:
          "Display is super bright even under direct sunlight in Islamabad. Calling is very clear.",
        verifiedPurchase: true,
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        date: "1 week ago",
        comment:
          "Same quality as balls used in international tournaments. Zero water absorption in rainy matches.",
        verifiedPurchase: true,
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        date: "3 days ago",
        comment:
          "Fabric is extremely soft and breathable for Multan heat. Colors remained bright after washing.",
        verifiedPurchase: true,
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        date: "5 days ago",
        comment:
          "Replaced both my laptop charger and phone charger with this single tiny adapter. Doesn’t heat up.",
        verifiedPurchase: true,
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        date: "6 days ago",
        comment:
          "MashAllah heavenly fragrance. Very rich and stayed on my Kurta even after 2 days.",
        verifiedPurchase: true,
      },
    ],
  },
...
export function getRelatedProducts(
  ...
  const sameCat = CATALOG_PRODUCTS.filter(
    (p) => p.category === category && p.productId !== currentId,
  );
