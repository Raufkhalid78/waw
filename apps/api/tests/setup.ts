...
process.env.APG_MERCHANT_ID = process.env.APG_MERCHANT_ID || "";
process.env.APG_STORE_ID = process.env.APG_STORE_ID || "";
process.env.APG_MERCHANT_USERNAME = process.env.APG_MERCHANT_USERNAME || "";
process.env.APG_MERCHANT_PASSWORD = process.env.APG_MERCHANT_PASSWORD || "";
process.env.APG_MERCHANT_HASH = process.env.APG_MERCHANT_HASH || "";
process.env.APG_KEY1 = process.env.APG_KEY1 || "";
process.env.APG_KEY2 = process.env.APG_KEY2 || "";
